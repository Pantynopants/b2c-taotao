package com.neusoft.search.dao.impl;
...
import com.neusoft.search.dao.SearchDao;
...
public class SearchDaoImpl implements SearchDao {
	...
	private HttpSolrClient solrServer;//5.5版本使用HttpSolrClient，实例化名称solrServer懒得改，注意
